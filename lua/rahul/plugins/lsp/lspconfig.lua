  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(ev)
        ...
        keymap.set("n", "<leader>D", "<cmd>Telescope diagnostics bufnr=0<CR>", opts) -- diagnostics for current file

        opts.desc = "Show line diagnostics"
        keymap.set("n", "<leader>d", vim.diagnostic.open_float, opts) -- diagnostics for current line
        ...
        -- New keymap to update the quickfix list with diagnostics and open Telescope's quickfix picker
        opts.desc = "List Quickfix items"
